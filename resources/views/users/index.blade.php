...
<body class="sidebar-mini clickup-chrome-ext_installed">
  ...
  <!-- End Google Tag Manager (noscript) -->
    ...
    @csrf</form>
    <div class="sidebar" data-color="morado">
      <!--
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>{{$user->email_verified_at}}</td>
                    <td class="text-right">
                                           <a type="button" href="{{route('users.update', $user->id)}}" rel="tooltip" class="btn btn-success btn-icon btn-sm " data-original-title="" title="">
